    ...
    <div className="flex h-screen">
      ...
      <div className="bg-white w-1/4 flex flex-col">
        ...
        <div className="p-2 text-center flex items-center justify-center">
          ...
          <button
            onClick={logout}
            className="text-sm bg-blue-100 py-1 px-2 text-gray-500 border rounded-md">logout</button>
        </div>
      </div>

      {/* Chat messages */}
      <div className="flex flex-col bg-gray-50 w-3/4 p-2">
        <div className="flex-grow">
          {/* Display messages or select a user */}
          {selectedUserId ? (
              ...
              <div className="overflow-y-scroll absolute top-0 left-0 right-0 bottom-2">
                ...
                {messagesWithoutDupes.map(message => (
                  <div key={message._id} className={(message.sender === id ? 'text-right' : 'text-left')}>
                    <div className={"text-left inline-block p-2 my-2 rounded-md text-md " + (message.sender === id ? 'bg-blue-400 text-white' : 'bg-white text-gray-500')}>
                      {message.text}
                      {message.file && (
                        <div className="">
